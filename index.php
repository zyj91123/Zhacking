...
<head>
<title>phpStudy for linux (lamp+lnmp 一键安装包) </title>
...
#lnmplink {position: absolute; top: 20px; left: 150px; text-align: right; font-weight: bold; color: #06C;}
...
<div id="page">
    <div id="header">
        <h1>phpStudy</h1>
         <div id="lnmplink">for <a href="http://www.phpstudy.net/" target="_blank">linux (lamp+lnmp 一键安装包)</a></div>
         <div id="lnmplink2"><a href="/phpinfo.php" target="_blank" class="links">phpinfo</a>　<a href="/phpmyadmin/" target="_blank">phpMyAdmin</a></div>
    </div>


<table width="100%" cellpadding="3" cellspacing="0">
  <tr><th colspan="4" style="font-size:20px">使用说明　　　Linux版 Win版同步上线，支持Apache/Nginx/Tengine/Lighttpd/IIS7/8/6</th></tr>
  <tr>
